...
- path: /etc/systemd/system/shutdown.service
  ...
  content: |
    ...
    WorkingDirectory={{ .Workdir }}
    Type=oneshot
    ExecStart=systemctl stop stackdriver-logging
